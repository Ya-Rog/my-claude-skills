...
|---|---|---|---|
| **[название]** | [1 предложение — что делает для пользователя] | [маркетплейс] ⚠️ Anthropic / community | **ДА/НЕТ/⛔ Пропустить** — [причина: язык вывода, шаблоны которые увидишь, хардкод под стек, потенциал улучшения, или почему пропустить] |

**Что писать в колонке "Стоит кастомизировать?":**
...
- Нет нормального маркетплейса / ручная установка → **⛔ Пропустить**
- Это MCP, не скил → пишем **"Это MCP, не скил"**, не в таблицу скилов

После таблицы — сразу итог: что устанавливаем и откуда.
